...
import com.example.course.core.designsystem.theme.SlateGray
        ...
        viewModel.channel.collect { channel ->
            when (channel) {
                SignUpChannel.UnavailableEmail -> snackbarHostState.showSnackbar(
                    message = context.getString(R.string.email_already_has_account_associated),
    ...
    Scaffold(
        ...
        Column(
            ...
            SignUpItem(
                ...
                repeatPassword = screenState.repeatPassword,
                ...
                repeatPasswordErrorResId = screenState.repeatPasswordErrorResId,
                isPasswordVisible = screenState.isPasswordVisible,
                focusManager = focusManager,
                onChangeEmailClick = { viewModel.changeEmail(value = it) },
                onChangePasswordClick = { viewModel.changePassword(value = it) },
                onChangeRepeatPasswordClick = { viewModel.changeRepeatPassword(value = it) },
...
fun SignUpItem(
    ...
    Column(
        ...
        Text(stringResource(R.string.sign_up), color = Color.White, fontSize = 22.sp)
        ...
        CustomOutlinedTextField(
            modifier = Modifier
                .fillMaxWidth(),
            value = email,
            onValueChange = { onChangeEmailClick(it) },
            placeholderString = stringResource(id = R.string.email_placeholder),
            errorMessage = safeStringResource(id = emailErrorResId),
            leadingIcon = { Icon(imageVector = LaIcons.Email, contentDescription = null) },
            trailingIcon = if (email.isEmpty()) null
            else {
                { ClearTrailingButton(onClick = { onChangeEmailClick("") }) }
            },
        ...
        CustomOutlinedTextField(
            ...
            value = password,
            onValueChange = { onChangePasswordClick(it) },
            placeholderString =
            ...
            leadingIcon = { Icon(imageVector = LaIcons.Password, contentDescription = null) },
            trailingIcon = {
        ...
        Text(stringResource(R.string.repeat_password), color = Color.White)

        CustomOutlinedTextField(
            modifier = Modifier.fillMaxWidth(),
            value = repeatPassword,
            onValueChange = { onChangeRepeatPasswordClick(it) },
            placeholderString =
                if (isPasswordVisible) stringResource(id = R.string.password_placeholder_show)
                else stringResource(id = R.string.password_placeholder_hide),
            leadingIcon = { Icon(imageVector = LaIcons.Password, contentDescription = null) },
            errorMessage = safeStringResource(id = repeatPasswordErrorResId),
            trailingIcon = {
                ToggleTextVisibilityTrailingButton(
                    onClick = onTogglePasswordVisibilityClick,
                    isVisible = isPasswordVisible
        ...
        Row(
            ...
            Text(text = stringResource(id = R.string.have_account), color = Color.White)
